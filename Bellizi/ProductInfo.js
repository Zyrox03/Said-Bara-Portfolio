...
// lilImages.children[0].children[0].src


// bigImage.children[0].src
...
let productPrice = document.querySelector('.command_Info b span').innerText
...
let close = document.querySelector('.formulaire .close i');
let command = document.querySelector('#command');
let formulaire = document.querySelector('.formulaire');

command.addEventListener('click', function () {
    formulaire.style.display = 'flex';
    total.innerText = (parseFloat(productPrice) * document.querySelector('.qty').children[1].value);
    functiondisable()
